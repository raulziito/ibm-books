function Footer() {
    return (
        <div className="mx-auto  py-16 xl:px-20 lg:px-12 sm:px-6 px-4 bg-gray-800">
            <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-3 xl:grid-cols-4 md:gap-8 gap-4">
                ...
                <div className="mt-10 lg:block hidden">
                    ...
                    <div className="cursor-pointer flex items-center justify-between border border-gray-800 mt-4">
                        <input
                            type="text"
                            className="text-base leading-4 p-4 w-full focus:outline-none text-white placeholder-gray-800 rounded-md mr-2"
